...
* PLAY
- aceita opt com nome de nota -> play note (symbol_or_number)
- aceita opt notação de acordes
#+BEGIN_SRC ruby
play chord(:e3, :e4, M7)
#+END_SRC
...
- aparentemente a duração da somatória do envelope /precisa/ ser um segundo. então:
#+BEGIN_SRC ruby
play_pattern [60, 61, 62], release: 0.2
#+END_SRC
...
mas sim
#+BEGIN_SRC ruby
play_pattern [60, 61, 62], attack: 0, sustain: 0, release: 0.2
#+END_SRC
